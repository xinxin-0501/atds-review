...
function ensureEntryUI(){
  ...
  pop.innerHTML = '<div class="entry-pop-h"><span>📌 今日已入场</span><span class="entry-pop-close" onclick="toggleEntryPop()">收起</span></div><div class="entry-pop-body"></div>';
