...
async function fetchKlineF(code, count) {
  ...
  try {
    ...
    if (Array.isArray(series) && series.length) {
      ...
      try { var kc=JSON.parse(localStorage.getItem('atds_kline_cache')||'{}'); kc[code]={date:bjTodayF(),series:series.slice(-120)}; localStorage.setItem('atds_kline_cache',JSON.stringify(kc)); } catch(e2) {}
      return series;
    }
  } catch (e) {}
