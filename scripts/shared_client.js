...
function buildWatchlistDetailHtml(data){
  ...
  var todayStHtml='<div class="wl-st-table">'+
    ...
    '<div class="wl-st-head"><span>入场</span><span>执行</span><span>风控</span></div>'+
    '<div class="wl-st-tr"><span class="wl-st-key">策略</span><span>'+escHtmlF(st.entryStrategy)+'</span><span class="wl-st-key">价格</span><span class="wl-st-num">'+escHtmlF(st.entryPrice)+'</span><span class="wl-st-key">仓位</span><span>'+escHtmlF(st.entryPosition)+'</span></div>'+
    '<div class="wl-st-tr"><span class="wl-st-key">止损</span><span class="wl-st-loss">'+escHtmlF(st.stopLoss)+'</span><span class="wl-st-key">止盈</span><span class="wl-st-profit">'+escHtmlF(st.takeProfit)+'</span><span class="wl-st-key">目标</span><span class="wl-st-num">'+escHtmlF(st.target)+'</span></div>'+
    (st.entryNote ? '<div class="wl-st-line wl-st-note-line"><span class="par-tag par-tag-plan">入场说明</span><span class="wl-st-content">'+escHtmlF(st.entryNote)+'</span></div>' : '')+
    '<div class="wl-st-risk"><b>风险</b>'+escHtmlF(st.risk)+'</div>'+
  '</div>';
