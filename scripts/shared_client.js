...
async function fetchStockFundFlowF(code){
  ...
  for(var attempt=0;attempt<3;attempt++){
    try{
      ...
      if(kl.length>=3){
        ...
        return writeCache(ff,'eastmoney-push2his')||ff;
      }
    }catch(e){/* 重试 */}
  }
  ...
  try{
    ...
    if(kl2.length){
      ...
      return writeCache(ff2,'eastmoney-push2')||ff2;
    }
