...
function resetLocalCache(){
  ...
  var CACHE_KEYS=['atds_watchlist_data','atds_watchlist_hidden','atds_kline_cache','atds_ff_cache','atds_lhb_cache','atds_events_cache','atds_trade_status','atds_shadow','atds_qr_code'];
